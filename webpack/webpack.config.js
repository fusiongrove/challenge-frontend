...
const getConfigBasedOnEnv = function() {
    switch(process.env.NODE_ENV) {
        case 'development': return path.join(__dirname, '/../src/config/dev.js'); break;
        case 'production': return path.join(__dirname, '/../src/config/prod.js'); break;
        default: return path.join(__dirname, '/../src/config/dev.js'); break;
    }
};
